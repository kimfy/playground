...
# ***************************
# Configure systemd-resolved (requires systemd 246 or higher, systemd 245 does not support target ports other than 53)
# ***************************
mkdir -p /etc/systemd/resolved.conf.d > /dev/null 2>&1
